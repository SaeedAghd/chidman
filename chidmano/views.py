...
def simple_home(request):
    ...
    context = {
        'hero_title': 'چیدمان فروشگاه با هوش مصنوعی | چیدمان مغازه | چیدمان فروشگاه',
        'hero_subtitle': 'چیدمان فروشگاه با هوش مصنوعی و چیدمان مغازه با هوش مصنوعی - راهکار جامع چیدمان فروشگاه و چیدمان مغازه برای افزایش فروش تا 30%.',
