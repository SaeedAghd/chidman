...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='usersubscription',
            name='package',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store_analysis.servicepackage', verbose_name='بسته'),
        ),
        migrations.AddField(
            model_name='usersubscription',
            name='payment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store_analysis.payment', verbose_name='پرداخت'),
        ),
